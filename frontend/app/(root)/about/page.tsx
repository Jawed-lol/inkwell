    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name='description'
                    content="Learn about Inkwell Bookstore's history, mission, and the passionate team behind our community-focused bookstore."
                />
                <meta
                    name='keywords'
                    content='Inkwell Bookstore, about us, bookstore history, mission, team, book lovers'
                />
                <meta
                    property='og:title'
                    content='About Inkwell Bookstore'
                />
                <meta
...
function HeroSection() {
    return (
        <motion.div
            ...
            <h1 className='font-author text-warmBeige text-4xl md:text-5xl mb-4'>
...
function OurStorySection() {
    return (
        <motion.div
            ...
            variants={sectionVariants}
            className='mb-12'>
            <h2 className='font-author text-warmBeige text-3xl md:text-4xl mb-4'>
                Our Story
            </h2>
...
function MeetTheTeamSection() {
    ...
    return (
        <motion.div
            ...
            variants={sectionVariants}
            className='mb-12'>
            <h2 className='font-author text-warmBeige text-3xl md:text-4xl mb-6 text-center'>
                Meet the Team
            </h2>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8'>
                {teamMembers.map((member, index) => (
                    <motion.div
                        ...
                        />
                        <h3 className='font-author text-xl text-warmBeige text-center'>
                            {member.name}
                        </h3>
